...
<template>
  <div class="relative z-0 group/float flex items-center w-full">
    <input
      ...
      :id="id"
      :class="[
        'block py-[14px] md:py-4 px-0 w-full text-lg leading-[22px] text-grayscaleLicorice bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer group-hover/float:border-grayscaleLicorice cyclone-input',
        error
    ...
    <label
      :for="id"
      :class="[
        'absolute text-lg leading-[22px] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto flex items-center gap-2',
        error
